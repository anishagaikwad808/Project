...
{
    public partial class Frm_Search_And_Accept_Payment : Form
    {
        public Frm_Search_And_Accept_Payment()
        {
            InitializeComponent();
        }
        ...
        private void Frm_Search_And_Accept_Payment_Load(object sender, EventArgs e)
        {
            tb_Member_Id.Focus();
            tb_Member_Name.Enabled = false;
        ...
        private void cmb_Package_Name_SelectedIndexChanged(object sender, EventArgs e)
        {
            cmb_Package_Type.Enabled = true;
        }
        ...
        private void btn_Search_Click(object sender, EventArgs e)
        {
           Well_Health_Gym_App_Shared_Content.Con_Open();
            ...
            {
                SqlCommand Cmd = new SqlCommand("Select Member_Name,Mobile_No,Join_Date From Member_Details Where Member_ID = '" + tb_Member_Id.Text + "'",Well_Health_Gym_App_Shared_Content.Con);
